...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://curriculum-machine-learning-operations-test.cloud.databricks.com/explore/data/models/staging/mlops_demo/mlops_demo-model)
* [Prod model in UC](https://curriculum-machine-learning-operations-test.cloud.databricks.com/explore/data/models/prod/mlops_demo/mlops_demo-model)
. 
