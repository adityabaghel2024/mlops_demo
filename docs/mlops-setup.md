...
git add README.md docs .gitignore mlops_demo/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://curriculum-machine-learning-operations-test.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://curriculum-machine-learning-operations-test.cloud.databricks.com#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[mlops_demo/databricks.yml](../mlops_demo/databricks.yml) file.
...
Follow the instructions in [mlops_demo/resources/README.md](../mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_demo/resources/README.md)  to propose, test, and deploy
